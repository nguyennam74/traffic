...
<div id="gameDiv">
 <!-- <button onclick='playRoutingGame("infotext")'>Play Routing Game</button>-->
  <button onclick='myRedirectGame()'>Play Routing Game</button>
</div>
...
<!-- PROJ--> <script src="<?=base_url()?>vendor/js/routing.js"></script> 
