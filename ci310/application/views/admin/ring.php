...
<head>
    ...
    <link href="<?=base_url()?>vendor/css/styleTrafficSimulationDe.css" rel="stylesheet" type="text/css"/>
...
<script src="<?=base_url()?>vendor/js/canvasresize.js" type="text/javascript"></script>
...
<!-- PROJ--> <script src="<?=base_url()?>vendor/js/ring.js"></script>
